...
For the installed daily PM receipt workflow, read [pm-operator.md](references/pm-operator.md) before enabling enforcement, recovering a partial run, or evaluating natural evidence.

For Phase 6 universal strategic review, action, and knowledge promotion
(evaluate/apply/promote/status across the four profiles, bounded snapshot,
outage honesty, pause/rollback, and later-worker promotion), read
[strategic-review-operator.md](references/strategic-review-operator.md).
